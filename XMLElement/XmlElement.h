...
* --------------------
* ver 1.6 : 19 Mar 15
* - Added getChildren() and getAttribute() Method in AbstractXmlElement,
* DocElement,TaggedElement,TextElement,CommentElement,ProcInstrElement,XmlDeclarElement
* completed toString() method in CommentElement,ProcInstrElement
* ver 1.5 : 22 Feb 15
...
namespace XmlProcessing
{
  ...
  inline std::vector<std::shared_ptr<AbstractXmlElement>> AbstractXmlElement::getChildren(){ return std::vector<std::shared_ptr<AbstractXmlElement>>(); };
  inline std::vector<std::pair<std::string, std::string>> AbstractXmlElement::getAttribute(){ return std::vector< std::pair<std::string, std::string>>(); };
  /////////////////////////////////////////////////////////////////////////////
