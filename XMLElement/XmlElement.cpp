...
//----< get attribute of Tagged element >-----------------------------
std::vector<std::pair<std::string, std::string>> TaggedElement::getAttribute()
{
	return attribs_;
...
//----< get attributes of ProcInstr element >-----------------------------
std::vector<std::pair<std::string, std::string>>  ProcInstrElement::getAttribute()
{
	return attribs_;
}
...
//----< add attribute to XMLDeclareElement >-----------------------------------
...
//----< get attributes of XMLDeclare element >-----------------------------
std::vector<std::pair<std::string, std::string>>  XmlDeclarElement::getAttribute()
{
	return attribs_;
}
...
int main()
{
  ...
  sPtr xmlDeclare = makeXmlDeclarElement();
  xmlDeclare->addAttrib("version","1.0");
  sPtr xmlComment = makeCommentElement("XML test case");
  ...
  root->addChild(child);
  //Doc element holfing the tree
  sPtr docEl = makeDocElement();
  docEl->addChild(xmlDeclare);
  docEl->addChild(xmlComment);
  docEl->addChild(root);
